      ...
      <main className="flex-grow container mx-auto px-4 mt-4 md:px-6 lg:px-8">
        ...
        >
          <motion.p
            ...
            className="text-xl md:text-2xl text-sky-600 mb-2"
          >
            Hey there! I&apos;m-
          </motion.p>
          <motion.h1
          ...
          >
            ...
            <span className="text-gray-400">
              Crafting dynamic web applications with a love for coding and
              problem-solving.
            </span>
          </motion.div>
          ...
          >
            {[
              {
                href: "https://github.com/Arunstha21",
                icon: Github,
                label: "Github",
              },
              {
                href: "https://www.linkedin.com/in/rangotengo/",
                icon: Linkedin,
                label: "LinkedIn",
              },
              {
                href: "mailto:me@arunshrestha.info.np",
                icon: Mail,
                label: "Email",
              },
            ].map((link) => (
